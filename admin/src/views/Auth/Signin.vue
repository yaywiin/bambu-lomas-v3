<template>
  <FullScreenLayout>
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4 bg-gray-50 dark:bg-gray-900">
      
      <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl px-6 py-10 sm:p-12 border border-gray-100 dark:border-gray-700">
        
        <div class="flex justify-center mb-8">
          <img src="/images/logo/logo.png" class="h-20 w-auto object-contain drop-shadow-md brightness-90 saturate-150" alt="Bambú Lomas Logo" />
        </div>

        <div class="mb-8 text-center">
          <h1 class="mb-2 font-bold text-gray-800 text-2xl dark:text-white/90">
            Iniciar Sesión
          </h1>
        ...
        <form @submit.prevent="handleSubmit">
          <div class="space-y-5">
            <!-- Usuario -->
            <div>
              <label for="usuario" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
            ...
            <!-- Error message -->
            <p v-if="errorMsg" class="text-sm text-error-500 text-center font-medium">{{ errorMsg }}</p>
